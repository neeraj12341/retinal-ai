  ...
  return (
    <div className="container mx-auto py-12 px-6">
      <div className="text-center mb-16 space-y-6">
        <h1 className="text-5xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-eye-primary to-eye-teal leading-tight px-4">
          Retinal Disease Diagnosis
        </h1>
        <div className="h-1 w-20 bg-gradient-to-r from-eye-primary to-eye-teal mx-auto mb-8"></div>
